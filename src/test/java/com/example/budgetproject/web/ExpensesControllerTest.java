...
class ExpensesControllerTest {
    ...
    void findAll() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/findAllExpenses").contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    void saveExpenses() throws Exception {
        FinanceEntity entity1 = new FinanceEntity();
        entity1.setAmount(458.00);
        repository.save(entity1);

        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/saveExpenses").contentType(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
                .andReturn();
    ...
    void deleteExpenses() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/deleteExpenses").contentType(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
                .andReturn();
    ...
    void searchExpenses() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/searchExpenses").contentType(MediaType.APPLICATION_JSON))
                .andDo(MockMvcResultHandlers.print())
                .andReturn();
